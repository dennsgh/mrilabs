...
from mrilabs.frontend.header import TICK_INTERVAL
...
from mrilabs.frontend.widgets.gen_oscilloscope import EDUX1002AOscilloscopeWidget
from mrilabs.frontend.widgets.gen_signal import DG4202SignalGeneratorWidget
